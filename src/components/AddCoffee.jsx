...
const AddCoffee = () => {
  ...
  const handleAddCoffe = event => {
    ...
    const newCoffe = { name, quantity, chef, supplier, category, details, photo };
  ...
  return (
    <div className='bg-amber-100 lg:p-20'>
      ...
      <h2 className='font-bold text-3xl text-center text-black pb-4'>Add Coffee</h2>
      ...
      <form onSubmit={handleAddCoffe} className='mb-10'>
        <div className="w-full shadow-2xl p-5">
          ...
          <input type="submit" className="btn btn-block bg-amber-100 text-black" value="Add Coffee" />
        </div>
      </form>
      <Footer></Footer>
    </div>
...
// https://i.ibb.co.com/Y7vDJWLj/1.png
// https://i.ibb.co.com/rR0p7TQh/2.png
// https://i.ibb.co.com/Zzz65Kd8/3.png
// https://i.ibb.co.com/HTQmVVBL/4.png
// https://i.ibb.co.com/TMP0bF60/5.png
// https://i.ibb.co.com/233MytQx/6.png
